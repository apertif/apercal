            ...
            if self.convert_ms2uvfits_tool == 'casa':
                ...
                if self.convert_fluxcal == True:
                    ...
                    if self.convert_ms2uvfits_tool_casa_autocorr:
                        ms.tofits(self.crosscaldir + '/' + str(self.fluxcal).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True)
                    else:
                        ms.tofits(self.crosscaldir + '/' + str(self.fluxcal).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True, uvrange='>0m')
                    ms.done()
                ...
                if self.convert_polcal == True:
                    ...
                    if self.convert_ms2uvfits_tool_casa_autocorr:
                        ms.tofits(self.crosscaldir + '/' + str(self.polcal).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True)
                    else:
                        ms.tofits(self.crosscaldir + '/' + str(self.polcal).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True, uvrange='>0m')
                    ms.done()
                ...
                if self.convert_target == True:
                    ...
                    if self.convert_ms2uvfits_tool_casa_autocorr:
                        ms.tofits(self.crosscaldir + '/' + str(self.target).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True)
                    else:
                        ms.tofits(self.crosscaldir + '/' + str(self.target).rstrip('MS') + 'UVFITS', column='DATA', combinespw=True, padwithflags=True, multisource=True, writestation=True, uvrange='>0m')
                    ms.done()
