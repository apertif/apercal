...
class transfer(BaseModule):
    ...
    def go(self):
        ...
        logger.info("Start copying of target data")
        self.copy_target_data()
        logger.info("Finished copying of target data")
        # check that there is a list of beams
        # if not there shoul
        if self.transfer_beam_list is None:
            self.transfer_beam_list = [self.beam]
