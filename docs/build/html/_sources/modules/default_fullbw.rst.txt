(Inactive) Configuration: 300-MHz pipeline
******************************************

This is a backup the configuration file for the processing the full bandwidth
...
::
    ...
    # =========================================================================
    # Default pipeline settings for processing Apertif data with full bandwidth
    # =========================================================================
    ...
    [SPLIT]
    split_startchannel = 0                             # First channel to split out
    ...
    preflag_targetbeams = 'all'                        # Targetbeams to flag, options: 'all' or '00,01,02'
    ...
    preflag_manualflag_targetbeams = 'all'              # Targetbeams to flag, options: 'all' or '00,01,02' (deprecated)
    ...
    preflag_aoflagger_targetbeams = 'all'               # Targetbeams to flag, options: 'all' or '00,01,02' (deprecated)
    ...
    continuum_chunkimage_startchannels = [0,32,64,96,128,160,192,224,256,288,320,352]      # Starting subbands for each chunk
    continuum_chunkimage_endchannels = [31,63,95,127,159,191,223,255,287,319,351]          # Ending subband for each chunk
    ...
    line_cube_channel_list = [[25, 3678], [3355, 7008], [6685, 10338], [10015, 13668], [13345, 16998], [16675, 20328], [20005, 23658], [23335, 24553]]
    line_cube_channelwidth_list = [3.6621e-05, 3.6621e-05, 3.6621e-05, 3.6621e-05, 3.6621e-05, 3.6621e-05, 3.6621e-05, 1.2207e-05] # list of channel widths of the cube for splitting data
